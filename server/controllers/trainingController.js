...
router.post('/create', authMiddleware, async (req, res) => {
    let createdProgram = await trainingService.create(req.body.data.mainInputTitle, req.body.data.container, req.body.data.category, req.params?.user?._id, req.body.data.visible, req.body.data?.price, req.body.data?.currency) || []
