        ...
        <>
            <div className={"add-event-wrapper " + (toggleActive ? 'active' : '')}>
                ...
                <div className='add-event-body'>
                    ...
                    <div className='add-event-input'>
                        <input minLength={1} maxLength={5} type='time' placeholder='Event Time From' value={container.timeFrom} onChange={(e) => changeValueHandler(e, 'timeFrom')} className='event-time-from' />
                    </div>
                    <div className='add-event-input'>
